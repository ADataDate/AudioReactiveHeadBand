...
int OUT = A0;//Connect pin 3 of the MSGEQ7, OUT, to A0 


int strobe = 3;//Connect pin 4 of the MSGQE7, Strobe, to D3

int reset = 5;//Connect pin 7 of the MSGEQ7, Reset, to D5
